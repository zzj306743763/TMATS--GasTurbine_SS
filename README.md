# T-MATS 单轴涡喷稳态示例
本仓库代码大部分经由AI完成，本人也还在不断学习中，如有不妥请多多包涵。

本仓库存放 NASA [T-MATS](https://github.com/nasa/T-MATS) 官方单轴涡喷**稳态**示例 `GasTurbine_SS`，并附带地面节流、高度特性和速度特性扫描脚本，参考教材为航空发动机原理 (廉筱纯, 吴虎) 。
